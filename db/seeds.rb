...
builds = [
  {
    ...
    :branch => 'master',
    :message => 'Add Gemfile',
    :committed_at => '2011-05-12 11:58:00',
    :committer_name => 'Sven Fuchs',
    :committer_email => 'svenfuchs@artweb-design.de',
    :status => 1,
    :started_at => '2011-05-12 1:00:00',
    :finished_at => '2011-05-12 1:00:10',
    :agent => '76f4f2ba',
  ...
  },
  {
    ...
    :committed_at => '2011-05-12 12:28:00',
    :committer_name => 'Sven Fuchs',
    :committer_email => 'svenfuchs@artweb-design.de',
    :author_name => 'Chris Floess',
    :author_email => 'flooose@gmail.com',
    :status => 0,
    :started_at => '2011-05-12 2:00:00',
    :finished_at => '2011-05-12 2:00:10',
    :agent => 'a1732e4f',
